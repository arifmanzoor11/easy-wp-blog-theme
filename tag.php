    ...
    <div
        ...
        <main
            ...
            <?php if (have_posts()): ?>
                ...
                // Add tax_query if taxonomy found
                if (!empty($taxonomy) && isset($term->slug)) {
                    $args['tax_query'] = [
                        [
                            'taxonomy' => $taxonomy,
                            'field' => 'slug',
                            ...
                            class="mb-5 pb-4 border-bottom"> <?php if (has_post_thumbnail()): ?>
                                <div class="mb-3">
                                    <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                        <img src="<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID(), 'thumbnail')); ?>" alt="<?php the_title_attribute(); ?>" loading="lazy" width="150" height="150" class="rounded shadow-sm img-fluid" decoding="async">
                                    </a>
                                </div>
                            <?php else: ?>
