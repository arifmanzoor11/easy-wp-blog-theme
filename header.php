        ...
        <div class="d-flex align-items-center gap-3">
          <small>
            <span class="text-light">
              ...
              <a href="mailto:support@guitarchordslyrics.com"
                class="text-decoration-none text-light">support@guitarchordslyrics.com</a>
            </span>
          </small>
          <!-- <span class="text-light">
        ...
        <div class="d-flex gap-3">
          <a href="https://www.facebook.com/GuitarChordslyrics1/" target="_blank" class="text-light" title="Facebook">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-facebook"
              viewBox="0 0 16 16">
              <path
                d="M8.94 6.38H7.5V5.3c0-.41.19-.79.8-.79h.6V3.12S8.3 3 7.94 3c-1.2 0-1.94.74-1.94 2.06v1.32H4.5V8.5h1.5V13h1.94V8.5h1.5l.25-2.12z" />
            </svg>
          </a>
